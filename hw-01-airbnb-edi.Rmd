...
answer: I used the facet_wrap to better show in an organized way how the listings and prices relate to eachother based on the specific neighbourhood.
...
labs(
  x = "price",
  title = "airbnb prices in the neighborhoods"
)
